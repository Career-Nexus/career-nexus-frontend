  ...
  return (
    <div className='max-h-screen'>
      <div className='grid grid-cols-12'>
        ...
        <div className='col-span-12 lg:col-span-5 md:p-4 p-0  mb-5'>
          <form className="bg-white px-16 space-y-5">
            <h1 className='font-bold text-center'>Welcome back</h1>

            <div className="max-w-md">
              <TextInput id="email4" type="email" icon={Email} className='w-full' placeholder=" Email Address" required />
            </div>
            <div className="max-w-md">
              <TextInput id="email4" type="email" icon={Password} className='w-full' placeholder=" Password" required />
            </div>
            <div className='flex gap-2 items-center'>
              <input type="checkbox" className='rounded border border-green-300' />
              <label> Remember me</label>
              <label className='ml-auto'> Forgot Password</label>
            </div>
            ...
            <p>Dont't have an account? <Link to={'/'} className='text-[#5DA05D]'>Sign up</Link></p>
