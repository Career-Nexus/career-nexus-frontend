...
// Scroll into view
document.querySelector('.menu a[href="#home"]').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#home').scrollIntoView({ behavior: 'smooth' });
;})
document.querySelector('.menu a[href="#jobs"]').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#jobs').scrollIntoView({ behavior: 'smooth' });
;})
document.querySelector('.menu a[href="#network"]').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#network').scrollIntoView({ behavior: 'smooth' });
;})
document.querySelector('.menu a[href="#mentorship"]').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#mentorship').scrollIntoView({ behavior: 'smooth' });
;})
document.querySelector('.menu a[href="#about"]').addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelector('#about').scrollIntoView({ behavior: 'smooth' });
;})
document.querySelector('.menu a[href="#contact"]').addEventListener('click', function(e) {
    e.preventDefault();
