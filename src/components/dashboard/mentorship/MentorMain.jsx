...
//               />
//             ))}
//             {/* <span className="text-black ml-1 text-xs">{mentor.rating}</span> */}
//           </div>
...
//               className={`w-full border rounded-lg p-4 flex justify-between items-center ${
...
//           Sarah is available Mon–Fri 9AM–6PM EST. Times shown are in your timezone (WAT).
//         </p>
//       </div>
...
//         className="w-full border rounded p-2 mb-6 text-sm"
//       ></textarea>
