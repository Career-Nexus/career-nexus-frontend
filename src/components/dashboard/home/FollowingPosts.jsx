        ...
        <div className="mt-3 grid grid-cols-12 gap-1 overflow-hidden">
          <div className="col-span-12">
            {post.pic1 && post.pic1 !== "N/A" && (
              <img src={post.pic1} alt="Post Image 1" className="w-full max-h-[250px] object-cover rounded-md" />
            )}
          </div>
          <div className="col-span-12 md:flex gap-1">
            {post.pic2 && post.pic2 !== "N/A" && (
              <img src={post.pic2} alt="Post Image 2" className="w-full max-h-[148px] object-cover rounded-md" />
            )}
            {post.pic3 && post.pic3 !== "N/A" && (
              <img src={post.pic3} alt="Post Image 3" className="w-full max-h-[148px] object-cover rounded-md" />
            )}
          </div>
        </div>
      )}
