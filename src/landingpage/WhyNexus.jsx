            ...
            <div className='pb-16 bg-gray-50 text-center'>
                ...
                <div className='mx-4 md:mx-20'>
                    <div className='grid grid-cols-5 gap-6'>
                        <div className='col-span-5 md:col-span-2 shadow rounded-lg w-full object-cover max-h-96 h-96 border-2 border-gray-200'>
                        ...
                        <div className='col-span-5 md:col-span-3 shadow rounded-lg w-full object-cover max-h-96 h-96 border-2 border-gray-200'>
                    ...
                    <div className='grid grid-cols-5 gap-6 mt-6'>
                        ...
                        <div className='col-span-5 md:col-span-2 shadow rounded-lg w-full object-cover max-h-96 h-96 border-2 border-gray-200'>
                            <div className='flex relative insert-0'>
                                <img src="/images/landing/landing2.png" alt="landing2" className='max-h-80 h-52 w-full object-cover' />
                            </div>
