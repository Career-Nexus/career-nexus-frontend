        ...
        <div className="grid grid-cols-12 min-h-screen">
            ...
            <div className='col-span-12 md:col-span-5 px-4 bg-white'>
                ...
                <button className='flex items-center justify-center mt-10 md:mt-[-1rem] w-full'>
                    <Link to="/mentor-profile" className='w-[50%] px-4 py-2 bg-[#5DA05D] text-white text-center rounded-md mx-auto border-0'>Setup Your Profile</Link>
                </button>
            </div>
