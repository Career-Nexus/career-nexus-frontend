...
const HeroTwo = () => {
    ...
    return (
        <div className="relative mb-10" id="waitlist">
            ...
            <div className="relative z-10 w-full flex flex-col justify-center items-center text-white px-3 text-center">
                ...
                {/* Waitlist Form */}
                <form onSubmit={handleSubmit} className="rounded-lg mx-2 mb-2 mt-10 md:mt-0 pb-1 bg-opacity-90 p-4 border border-gray-300">
